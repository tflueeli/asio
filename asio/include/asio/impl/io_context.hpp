...
io_context::basic_executor_type<StaticProperties,
...
template <unsigned int StaticProperties, typename Allocator>
inline bool io_context::basic_executor_type<StaticProperties,
...
void io_context::basic_executor_type<StaticProperties,
    Allocator>::execute(ASIO_MOVE_ARG(Function) f) const
{
  ...
  if ((properties_ & blocking_never) == 0 && io_context_->impl_.can_dispatch())
  {
  ...
  io_context_->impl_.post_immediate_completion(p.p,
      properties_ & relationship_continuation);
  p.v = p.p = 0;
}
...
inline io_context& io_context::basic_executor_type<
    StaticProperties, Allocator>::context() const ASIO_NOEXCEPT
{
  return *io_context_;
}

template <unsigned int StaticProperties, typename Allocator>
inline void io_context::basic_executor_type<StaticProperties,
...
void io_context::basic_executor_type<StaticProperties, Allocator>::dispatch(
...
template <unsigned int StaticProperties, typename Allocator>
template <typename Function, typename OtherAllocator>
void io_context::basic_executor_type<StaticProperties, Allocator>::post(
    ASIO_MOVE_ARG(Function) f, const OtherAllocator& a) const
{
  typedef typename decay<Function>::type function_type;
...
template <unsigned int StaticProperties, typename Allocator>
template <typename Function, typename OtherAllocator>
void io_context::basic_executor_type<StaticProperties, Allocator>::defer(
    ASIO_MOVE_ARG(Function) f, const OtherAllocator& a) const
{
  typedef typename decay<Function>::type function_type;
